# a copy of rust-bert/utils/convert_model.py modified to 
# use convert-tensor binary instead of cargo run
...
if __name__ == "__main__":
    ...
    subprocess.run(
        ['/usr/src/rust-bert/target/debug/convert-tensor', source, target],
    )
    print('done')