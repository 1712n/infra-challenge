...
class TritonPythonModel:
    ...
    def execute(self, requests) -> "List[List[pb_utils.Tensor]]":
        ...
        for request in requests:
            ...
            query = [t.decode("ascii", "ignore") for t in pb_utils.get_input_tensor_by_name(request, "TEXT").as_numpy().tolist()]
            ...
            tokens = {k: np.array(v, dtype=np.int32) for k, v in tokens.items()}
